module RISC_SPM (clk, rst);
	...
	wire Load_Add_Reg, Load_Reg_Y, Load_Reg_Z;
	wire write;
	
	Processing_Unit M0_Processor
		(instruction, zero, address, Bus_1, mem_word, Load_R0, Load_R1, Load_R2, Load_R3, Load_PC, Inc_PC, Sel_Bus_1_Mux, 
		Sel_Bus_2_Mux, Load_IR, Load_Add_Reg, Load_Reg_Y, Load_Reg_Z, clk, rst);
	
	Control_Unit M1_Controller
		(Load_R0, Load_R1, Load_R2, Load_R3, Load_PC, Inc_PC, Sel_Bus_1_Mux, Sel_Bus_2_Mux, Load_IR, Load_Add_Reg, Load_Reg_Y,
...
module Processing_Unit (instruction, Zflag, address, Bus_1, mem_word, Load_R0, Load_R1, Load_R2, Load_R3, Load_PC, Inc_PC,
						Sel_Bus_1_Mux, Sel_Bus_2_Mux, Load_IR, Load_Add_Reg, Load_Reg_Y, Load_Reg_Z, clk, rst);
	parameter word_size = 8;
	parameter op_size = 4;
	parameter Sel1_size = 3;
	parameter Sel2_size = 2;
	...
	Address_Register		 Add_R (address, Bus_2, Load_Add_Reg, clk, rst);
	
	Program_Counter 		 PC	(PC_count, Bus_2, Load_PC, Inc_PC, clk, rst);
	Instruction_Register	 IR (instruction, Bus_2, Load_IR, clk, rst);
	
	Mux_5ch					 Mux_1 (Bus_1, R0_out, R1_out, R2_out, R3_out, PC_count, Sel_Bus_1_Mux);
	Mux_3ch					 Mux_2 (Bus_2, alu_out, Bus_1, mem_word, Sel_Bus_2_Mux);
...
module Mux_5ch (mux_out, data_a, data_b, data_c, data_d, data_e, sel);
	parameter word_size = 8;
...
module Mux_3ch (mux_out, data_a, data_b, data_c, sel);
	parameter word_size = 8;
	output [word_size-1:0] mux_out;
...
module Alu_RISC (alu_zero_flag, alu_out, data_1, data_2, sel);
	...
	assign alu_zero_flag = (alu_out == 0);
...
module Control_Unit(
	...
	//State
	parameter S_idle = 0, S_fet1 = 1, S_fet2 = 2, S_dec = 3, S_ex1 = 4, S_rd1 = 5, S_rd2 = 6, S_wr1 = 7, 
				 S_wr2 = 8, S_br1 = 9, S_br2 = 10, S_halt = 11;
	//opcode
	...
	parameter R0 = 0, R1 = 1, R2 = 2, R3 = 3;
	 ...
	 output Load_IR, Load_Add_R, Load_Reg_Y, Load_Reg_Z;
	 output write;
	 ...
	 wire [op_size-1:0] opcode = instruction[word_size-1:word_size-op_size];
	 wire [src_size-1:0] source = instruction[word_size-op_size-1:word_size-op_size-src_size];
	 wire [dest_size-1:0] destination = instruction[dest_size-1:0];
	...
	always@(*)
		begin
			Sel_R0 = 0; Sel_R1 = 0; Sel_R2 = 0; Sel_R3 = 0; Sel_PC = 0;	//MUX1
			Load_R0 = 0; Load_R1 = 0; Load_R2 = 0; Load_R3 = 0; Load_PC = 0; 
			Load_IR = 0; Load_Add_R = 0; Load_Reg_Y = 0; Load_Reg_Z = 0;
			Inc_PC = 0;
			Sel_Bus_1 = 0; Sel_ALU = 0; Sel_Mem = 0; //MUX2
			write = 0;
			err_flag = 0;
